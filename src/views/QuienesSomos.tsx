    ...
    return (
      <>
        ...
        <div className="flex flex-col items-center justify-center md:w-1/2">
          <div className="text-caverna p-2 md:p-8 w-full text-center">
            <h1 className="text-4xl md:text-6xl font-bold md:mb-4">¿Quiénes Somos?</h1>
          </div>
          <div className="text-caverna p-2 md:p-10 w-full">
            <p className="mb-4">
          ...
          <div className="md:flex bg-caverna">
            <div className="text-white p-6 md:p-10 md:w-1/2 flex flex-col justify-center hover:bg-[#2e3537] transform transition-transform duration-500 hover:scale-105 group">
          ...
          <div className=" text-caverna py-4 px-10 w-full">
            ...
            <div className="grid md:grid-cols-4 gap-4">
              <div className="text-center bg-acido text-caverna p-4 rounded-lg transform transition-transform duration-500 hover:scale-105 group">
              ...
              <FontAwesomeIcon icon={faHeart} size="4x" className="text-caverna pt-4 transform transition-transform duration-500 group-hover:scale-125" /> 
              </div>
              <div className="text-center bg-acido text-caverna p-4 rounded-lg transform transition-transform duration-500 hover:scale-105 group">
              ...
              <FontAwesomeIcon icon={faPersonWalkingWithCane} size="4x" className="text-caverna pt-4 transform transition-transform duration-500 group-hover:scale-125" /> 
              </div>
              <div className="text-center bg-acido text-caverna p-4 rounded-lg transform transition-transform duration-500 hover:scale-105 group">
              ...
              <FontAwesomeIcon icon={faHandshakeSimple} size="4x" className="text-caverna pt-4 transform transition-transform duration-500 group-hover:scale-125" /> 
              </div>
              <div className="text-center bg-acido text-caverna p-4 rounded-lg transform transition-transform duration-500 hover:scale-105 group">
              ...
              <FontAwesomeIcon icon={faScaleBalanced} size="4x" className="text-caverna pt-4 transform transition-transform duration-500 group-hover:scale-125" /> 
              </div>
            </div>
          </div>
          <div className="text-caverna py-4 px-10 w-full">
            <h2 className="text-center text-4xl font-bold mt-6 mb-6">Objeto Social</h2>
            <p className="text-center mb-4 bg-caverna text-acido p-8 pt-6 px-6 md:px-20 rounded-lg hover:scale-105 transition-transform duration-300">
            ...
            <p className="text-center mb-4 bg-caverna text-acido p-8 pt-6 rounded-lg hover:scale-105 transition-transform duration-300">
